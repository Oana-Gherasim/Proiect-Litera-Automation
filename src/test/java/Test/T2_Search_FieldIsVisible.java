...
public class T2_Search_FieldIsVisible extends BaseTest {
    public HelpMethods helpMethods;
    @Test
    public void buttonIsVisisble(){
        ...
        Assert.assertTrue(searchField.isDisplayed(),"Search field is not visible");
    }
}
