...
public class T16_Checkout_CantBuyWithEmptyFields extends BaseTest {
    ...
    public void assertSummaryCanBeModified() {
        ...
        WebElement plaseazaComandaButton = driver.findElement(By.xpath("//button[@class='action primary checkout amasty']"));
        plaseazaComandaButton.click();

        WebElement messagePopUp = driver.findElement(By.xpath("//aside[@class='modal-popup confirm _show']/div/div/div"));
        String expectedMsg = "No payment method selected";
        helpMethods.checkMessage(messagePopUp, expectedMsg);
