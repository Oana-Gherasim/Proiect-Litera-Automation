...
public class T20_Checkout_VisibleAddressArea extends BaseTest {
    public HelpMethods helpMethods;
    @Test
    public void assertShippingAddressArea() {
        ...
        //Assert that the user can see the fields in "Adresa de livrare" area
        WebElement shippingAddressArea = driver.findElement(By.id("checkout-step-shipping"));
        Assert.assertTrue(shippingAddressArea.getAttribute("aria-hidden").contains("false"));
